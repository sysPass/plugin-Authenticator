...
"vpn_key"));d.show("slow")}else a.msg.out(c)})}},checkVersion:function(){d.info("Authenticator:checkVersion");var b=a.appRequests().getRequestOpts();b.url="/inc/Plugins/Authenticator/ajax/ajax_checkVersion.php";b.method="get";b.useLoading=!1;return a.appRequests().getActionCall(b,function(a){if(0===a.status)return a.data[0].Authenticator.version})}}};
